...
| Módulo | Descrição |
|--------|-----------|
| **Dashboard** | Panorama geral das obras e empresas |
| **Leads** | Pesquisa de Obras, Empresas, Imóveis utilizando API externas e dados do Supabase |
| **CRM** | Gestão de relacionamento com leads e Empresas |
| **Consulta Plus** | Busca livre por CNPJ/CPF |
| **Chat IA** | Assistente de IA para pesquisas |
| **Painel ADM** | Gestão de usuários, empresas, créditos e APIs |
| **SDR** | Prospecção automatizada via integração com WhatsApp (Evolution API) |

### APIs Externas

- **PH3**: Dados de PJ e PF (nome, telefone, e-mail)
- **Zoox**: Dados de PJ e PF (CPF e CNPJ)
